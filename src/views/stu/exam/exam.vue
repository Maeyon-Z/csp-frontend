    ...
    <el-card class="box-card">
        <template #header>
            <el-row>
                ...
                <el-col :span="6"> <span style="font-size:30px">{{ "剩余时间：" +  parseInt(remainder/60) + "分" + remainder%60 + "秒" }} </span> </el-col>
            </el-row>
        </template>
...
import { getStuExamById } from '@/api/stu/exam'
...
const data = reactive({
    stuExamInfo: {}, paperInfo: {}, remainder: 1,
});
const { 
    stuExamInfo, paperInfo, remainder
} = toRefs(data);
